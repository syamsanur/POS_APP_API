...
router
    ...
    .get('/product/getproduct/:id', auth.authentication, auth.authorization, redis.GetProduct, c_posappProduct.getProduct)
    ...
    .get('/category/getall', auth.authentication, auth.authorization, redis.getAllCategory, c_posappCategory.getAll)
    .get('/category/getcategory/:id', auth.authentication, auth.authorization, redis.getCategory, c_posappCategory.getCategory)    
